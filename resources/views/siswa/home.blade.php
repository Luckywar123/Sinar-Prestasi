...
<style>
    .img-opacity {
        opacity: 0.65; /* opacity / transparation */
    }
</style>
...
@section('content')
    <div class="content mt-5">
        <div class="row align-items-center">
            <div class="col-md-2 col-4"> <!-- Ubah menjadi 4 kolom pada perangkat seluler -->
                <img src="{{ asset('assets/logo.png') }}" alt="Logo" style="width: 100px; height: 100px" class="img-fluid">
            </div>
            <div class="col-md-10 col-8"> <!-- Ubah menjadi 8 kolom pada perangkat seluler -->
    ...
    <div class="row mt-4">
        <div class="col-md-12">
        <p class="text-left" style="color: rgba(0, 0, 0, 1); font-size: 1.5rem;"> <!-- Menambahkan properti font-size: 1.2rem; untuk memperbesar tulisan -->
        ...
        <p class="text-left" style="color: rgba(0, 0, 0, 1); font-size: 1.5rem;"> <!-- Sama seperti di atas, menambahkan properti font-size: 1.2rem; untuk memperbesar tulisan -->
