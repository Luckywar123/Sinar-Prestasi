        ...
        <div class="carousel-inner">
            ...
            <div class="image-container">
                ...
                <div class="carousel-item active">
                    <img src="{{ asset('assets/background2.jpeg') }}" class="d-block w-100 img-opacity"
                        alt="Background Image 2">
                </div>
                <div class="carousel-item">
                    <img src="{{ asset('assets/background3.jpeg') }}" class="d-block w-100 img-opacity"
...
@section('content')
    <div class="content mt-5" style ="padding-top: 250px; position: absolute;">
        <div class="row align-items-center">
            ...
            <div class="col-md-10 ">
                <h1 class="display-4 text-start fw-bold outlined-text"
                    style="color: #5DB6FA; text-shadow: 2px 2px 4px #000000;">Bimbingan Belajar</h1>
        ...
        <div class="row mt-4">
            <div class="col-md-12">
                <p class="text-left" style="color: rgba(0, 0, 0, 1); font-size: 1.1rem; text-align: justify; ">
                    <!-- Menambahkan properti font-size: 1.2rem; untuk memperbesar tulisan -->
                ...
                <p class="text-left" style="color: rgba(0, 0, 0, 1); font-size: 1.1rem;text-align: justify;">
                    <!-- Sama seperti di atas, menambahkan properti font-size: 1.2rem; untuk memperbesar tulisan -->
                ...
                <p class="text-left" style="color: rgba(0, 0, 0, 1); font-size: 1.1rem;text-align: justify;">
                    ...
                    telah menyediakan asrama, dengan adanya asrama menjadikan siswa dan siswa lebih fokus dalam latihan dan
                    belajar.
        ...
        <div class="row mt-2 justify-content-end">
            <div class="col-md-3 col-12"> <!-- Ubah menjadi 12 kolom pada perangkat seluler -->
                ...
                <a href="/testimoni" class="btn btn-md rounded-pill px-4"
                    style="background-color: #0F3077; color:#DFF8FD">Testimoni</a>
            </div>
        </div>
    </div>
    ...
    <style>
        .outlined-text {
            ...
            /* Warna biru muda untuk garis di dalam huruf */
            -webkit-text-stroke: 1px #87CEFA;
            /* Untuk browser yang menggunakan prefiks vendor -webkit- */
            -moz-text-stroke: 1px #87CEFA;
            /* Untuk browser yang menggunakan prefiks vendor -moz- */
            color: black;
            /* Warna teks */
        }
    </style>
