...
<div class="row">
    <div class="col-4 mb-5" style="border: 1px solid #0F3077;">
        <h4 class="text-center my-2" style="color: #0F3077">Formulir Pendaftaran Siswa</h4>
    </div>

    <div class="col-12">
        <div class="card rounded-5 mt-3 py-2" style="border-radius: 1rem">
            <div class="card-body px-5 py-4">
                <form action="{{route('simpanDataSiswa')}}" method="POST" id="formTambahSiswa">
                    @csrf
                    ...
                    <div class="form-group row mb-4">
                        <label for="birth_place" class="col-sm-2 col-form-label text-right">Tempat Lahir <span style="color: red">*</span></label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control form-control" id="birth_place" name="birth_place" placeholder="Tempat Lahir" required>
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                        <label for="birth_date" class="col-sm-2 col-form-label text-right">Tanggal Lahir <span style="color: red">*</span></label>
                        <div class="col-sm-10">
                            <input type="date" class="form-control form-control" id="birth_date" name="birth_date" placeholder="Tempat Lahir" required>
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                        <label for="Laki-Laki" class="col-sm-2 col-form-label text-right">{{ __('Jenis Kelamin') }} <span style="color: red">*</span></label>
                        <div class="col-sm-10">
