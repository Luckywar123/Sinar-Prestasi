...
<div class="row">
    <div class="col-12 mb-4 align-items-center">
        <h2 class="text-center my-2 fw-semibold" style="color: #0F3077">Ubah Data Guru</h2>
    ...
    <div class="col-12">
        <div class="card rounded-5 mt-3 py-2" style="border-radius: 1rem">
            <div class="card-body px-5 py-4">
                <form action="/admin/update-data-guru/{{ $user->user_id }}" method="POST" id="formUbahGuru">
                    @csrf
                    @method('PATCH')
                    <div class="form-group row mb-4">
                        <label for="full_name" class="col-sm-2 col-form-label text-right">Nama Lengkap <span style="color: red">*</span></label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control form-control" id="full_name" name="full_name" value="{{ $user->full_name }}" required>
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                        <label for="email" class="col-sm-2 col-form-label text-right">Email <span style="color: red">*</span></label>
                        <div class="col-sm-10">
                            <input type="email" class="form-control form-control" id="email" name="email" value="{{ $user->email }}" required>
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                        <label for="username" class="col-sm-2 col-form-label text-right">Username <span style="color: red">*</span></label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control form-control" id="username" name="username" value="{{ $user->username }}" required>
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-10">
                            ...
                            {{-- <div class="text-warning" style="display: block;">Kosongkan bagian ini jika tidak ada perubahan password</div> --}}
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                        <label for="konfirmasiPassword" class="col-sm-2 col-form-label text-right">Konfirmasi Password</label>
                        <div class="col-sm-10">
                            <input type="password" class="form-control form-control" id="konfirmasiPassword" name="konfirmasiPassword" placeholder="Konfirmasi Password">
